...
# Create the mysql user for the application
GRANT SELECT,INSERT,UPDATE ON auter_checkmate.* TO 'auter-checkmate'@'localhost' IDENTIFIED BY 'access';
FLUSH PRIVILEGES;

# Test Data
insert into auter_checkmate.servers values ('test','paolo-auter-checkmate7','192.168.0.1');
insert into auter_checkmate.serverstatus values ('test','1');
