...
create table auter_checkmate.serverstatus (serverid INT NOT NULL, statusid INT NOT NULL, FOREIGN KEY (serverid) REFERENCES servers(serverid), FOREIGN KEY (statusid) REFERENCES statuses(statusid));
